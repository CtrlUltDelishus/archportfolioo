...
function triggerConfetti() {
  return new Promise((resolve) => {
    var duration = 5 * 1000; // Duration of the confetti effect in milliseconds
    var confettiOptions = {
      particleCount: 100, // Number of confetti particles
      spread: 160, // Spread of the particles
      origin: { y: 0.6 }, // Starting point on the Y-axis (top)
    };

    // Create the confetti animation
    var confetti = new ConfettiGenerator(confettiOptions);
...
const Home = () => {
  ...
  const [isConfettiFinished, setConfettiFinished] = useState(false);

  useEffect(() => {
    if (isConfettiFinished) {
      router.push('/works');
    }
  }, [isConfettiFinished, router]);
  ...
  return (
    <Layout>
      <Container>
        ...
        >
          Hello, I&apos;m Harris, an architecture student based in Greece & Cyprus! P.S Profile picture will change
        </Box>
        ...
        <Box display={{ md: 'flex' }}>
          ...
          <Box flexShrink={0} mt={{ base: 4, md: 0 }} ml={{ md: 6 }} textAlign="center">
            <Box
              ...
              overflow="hidden"
            >
              <ProfileImage src="/images/takuya.jpg" alt="Profile image" borderRadius="full" width="100" height="100" />
            </Box>
          </Box>
        </Box>
        ...
        <Section delay={0.1}>
          ...
          <Box mb={4}>
            <Paragraph>
              I am an architecture student with extensive knowledge in various design programs, including AutoCAD, Sketchup,
              Lumion, Photoshop, and ArchiCAD. With a diploma in AutoCAD, I have honed my technical skills to produce accurate
          ...
          <Box mb={4}>
            <Paragraph>
              I am passionate about creating innovative and sustainable designs that enhance the built environment. I have
              experience working on a range of projects, from residential to commercial (university projects), as well as freelance
              works, and I am always eager to take on new challenges.
            </Paragraph>
          </Box>

          <Box mb={4}>
            <Paragraph>
              Thanks to my expertise in design programs, I am able to bring my ideas to life with 3D visualizations that capture
              the essence of my designs. I believe that good design should not only be functional but also aesthetically pleasing,
              and I always strive to achieve both in every project I work on.
            </Paragraph>
          </Box>
          <Box align="center" my={4}>
            <Button as={NextLink} href="/works" scroll={false} rightIcon={<ChevronRightIcon />} colorScheme="teal" onClick={triggerConfetti}>
              My portfolio
            </Button>
          </Box>
        </Section>
          ...
          <List>
            <ListItem>
              <Link href='https://www.gmail.com/' target="_blank">
                <Button variant='ghost' colorScheme="teal" leftIcon={<IoLogoChrome />}>
